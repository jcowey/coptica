...
<TEI xmlns="http://www.tei-c.org/ns/1.0" xml:lang="en">
    <teiHeader type="text">
        <fileDesc>
            <titleStmt>
                <title>P.Mon.Epiph. 107</title>                            <!-- change accordingly, use HGV: title -->
            </titleStmt>
            <publicationStmt>
                <authority>Duke Collaboratory for Classics Computing (DC3)</authority>
                <idno type="filename">86640</idno>                        <!-- same as the TM value -->
                <idno type="TM">86640</idno>                              <!-- TM number value -->
                <idno type="HGV">86640</idno>                             <!-- same as the TM value -->
                <idno type="ddb-hybrid">p.mon.epiph;;107</idno>          <!-- ddb-hybrid value -->
                <availability>
        ...
        <revisionDesc>
            <change when="2026-01-16T08:21:29-04:00"                                   <!-- change date accordingly -->
                who="http://papyri.info/editor/users/thomaslaver">Uploaded translation from the volume with added line breaks</change>
        </revisionDesc>
    </teiHeader>
    <text>
        <body>
            ...
            <p>                                                             
               ...
               <milestone n="1" unit="line"/> Herakleitos
                ...
                <note>Translation: W.E. Crum and H.G. Evelyn White, P.Mon.Epiph., p. </note>        <!-- add the page number accordingly -->      
            </p>
         </div>
        </body>
    </text>
